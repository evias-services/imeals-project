...
function Datepicker() {
	...
	this.regional = ["fr", "de"]; // Available regional settings, indexed by language code
    ...
    this.regional["fr"] = { // Default regional settings
		closeText: "Continuer", // Display text for close link
		prevText: "Mois précédent", // Display text for previous month link
		nextText: "Mois suivant", // Display text for next month link
		currentText: "Aujourd'hui", // Display text for current month link
		monthNames: ["Janvier","Février","Mars","Avril","Mai","Juin",
			"Juillet","Aôut","Septembre","Octobre","Novembre","Décembre"], // Names of months for drop-down and formatting
		monthNamesShort: ["Janvier","Février","Mars","Avril","Mai","Juin",
			"Juillet","Aôut","Septembre","Octobre","Novembre","Décembre"], // Names of months for drop-down and formatting
		/*monthNamesShort: ["Jan", "Fév", "Mar", "Avr", "Mai", "Jui", "Juil", "Aou", "Sep", "Oct", "Nov", "Dec"], // For formatting*/
    ...
    this.regional["de"] = { // Default regional settings
		...
		prevText: "Voriges Monat", // Display text for previous month link
		nextText: "Nächstes Monat", // Display text for next month link
